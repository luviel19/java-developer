...
public class equals {
    public static void main(String[] args){
        ...
        wolf01.setStrength(1);wolf01.setAge(2);wolf01.setName("Волк");
        wolf02.setStrength(1);wolf02.setAge(2);wolf02.setName("Волк");
        wolf03.setStrength(1);wolf03.setAge(2);wolf03.setName("Волк");
